...
required_columns = ['A', 'B', 'C', 'Response']
...
# Define models
formula_linear = 'Response ~ A + B + C'
formula_square = 'Response ~ A + B + C + A_sq + B_sq + C_sq'
formula_interaction = 'Response ~ A + B + C + A_B + A_C + B_C'
...
print(f"Equation: Response = {model_linear.params[0]:.3f} + {model_linear.params[1]:.3f}*A + {model_linear.params[2]:.3f}*B + {model_linear.params[3]:.3f}*C\n")
...
print(f"Equation: Response = {model_square.params[0]:.3f} + {model_square.params[1]:.3f}*A + {model_square.params[2]:.3f}*B + {model_square.params[3]:.3f}*C + {model_square.params[4]:.3f}*A^2 + {model_square.params[5]:.3f}*B^2 + {model_square.params[6]:.3f}*C^2\n")
...
print(f"Equation: Response = {model_interaction.params[0]:.3f} + {model_interaction.params[1]:.3f}*A + {model_interaction.params[2]:.3f}*B + {model_interaction.params[3]:.3f}*C + {model_interaction.params[4]:.3f}*A*B + {model_interaction.params[5]:.3f}*A*C + {model_interaction.params[6]:.3f}*B*C\n")
